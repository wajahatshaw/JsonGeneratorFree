...
export const DesktopSidebar = ({
  ...
  return (
    <motion.div
      className={cn(
        "h-screen px-4 py-4 hidden md:flex md:flex-col bg-gray-100 dark:bg-gray-800 flex-shrink-0 overflow-hidden",
        className
      )}
      animate={{
...
export const MobileSidebar = ({
  ...
  return (
    <>
      <div
        className={cn(
          "h-10 px-4 py-4 flex flex-row md:hidden items-center justify-between bg-gray-100 dark:bg-gray-800 w-full"
        )}
        {...props}
      >
        ...
        <AnimatePresence>
          {open && (
            ...
            >
              <div
                className="absolute right-10 top-10 z-50 text-gray-700 dark:text-gray-200 cursor-pointer"
                onClick={() => setOpen(!open)}
              >
                <X />
              </div>
